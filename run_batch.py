...
def parse_args():
    ...
    parser.add_argument('--vlmeval_mode', type=str, default='all', choices=['all', 'infer'])
    parser.add_argument('--deploy_backend', type=str, default='vllm', choices=['vllm', 'lmdeploy', 'swift'])
